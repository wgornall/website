...
\usepackage{microtype, cmbright, titlesec, enumitem, fancyhdr, lastpage, hyperref, url, multirow}
...
% List settings
\setlist[itemize]{labelsep=*, leftmargin=1.7cm, align=left, labelwidth=*, label={},   }

% Header and footer
\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\lfoot{\vspace{-0.5cm}\quad\quad CV: Will Gornall}
\cfoot{\vspace{-0.5cm}\thepage/\pageref{LastPage}}
\rfoot{\vspace{-0.5cm}2024-09-02 \quad\quad}
